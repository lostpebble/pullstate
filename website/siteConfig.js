...
const siteConfig = {
  ...
  headerLinks: [{ doc: "quick-example", label: "Docs" }, { href: 'https://lostpebble.github.io/pullstate-typedoc/', label: 'API Reference' }, { href: 'https://github.com/lostpebble/pullstate', label: 'GitHub' }],
